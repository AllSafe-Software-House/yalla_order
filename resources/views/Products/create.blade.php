...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Products</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ADD Products</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="card">
    ...
    @endif
    <div class="card-body">
        <form action="{{ Route('productstore') }}" class="d-grid" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="mb-3">
