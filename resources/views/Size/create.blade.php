...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"><a href="{{ route('sizelist') }}" style="color: #FD7E7E">Size</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ADD Size</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('sizestore') }}" class="d-grid" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="mb-3">
                <label for="place_id" class="py-2">Restaurant:</label>
