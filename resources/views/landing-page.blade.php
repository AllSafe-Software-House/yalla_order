...
<head>
    ...
    <style>
        /* Loader CSS */
        .loader {
            border: 16px solid #a99c92;
            /* Light grey */
            border-top: 16px solid #fb6e14;
            /* Blue */
            border-radius: 50%;
            width: 120px;
            height: 50px;
        ...
        .overlay {
            ...
            z-index: 9999;
            /* Ensure it's above all other elements but below the loader */
            display: none;
            /* Hidden by default */
        }
    ...
    <div id="fh5co-container">
                ...
                <div class="fh5co-text">
                    <div class="container">
                        <div class="row">
                            ...
                            <h2 class="to-animate">تم التصميم بواسطة <a href="https://www.allsafeeg.com/"
                                    target="_blank">All Safe</a></h2>
                        </div>
                    </div>
                </div>
                <ul class="slides">
                    <li style="background-image: url(public/front/images/slide_1.jpg);"
                        data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(public/front/images/slide_2.jpg);"
                        data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(public/front/images/slide_3.jpg);"
                        data-stellar-background-ratio="0.5"></li>
                </ul>
                    ...
                    <div class="col-md-6 to-animate-2">
                        ...
                        <div class="form-group " id="success-message" style="display:none; top: 50%; left: 50%;">
                            ...
                            <div style="text-align: center;margin-top: 330px;">
                                <img src="{{asset('front/images/send-successfully.png')}}" alt="Success"
                                    class="success-image" id="success-image">
                            </div>
                        </div>
        ...
        <div id="fh5co-about" data-section="about">
            <div class="fh5co-2col fh5co-bg to-animate-2"
                style="background-image: url(public/front/images/res_img_1.jpg)"></div>
    ...
    <div id="fh5co-footer">
        <div class="container">
            <div class="row row-padded">
                ...
                <div class="col-md-6 text-center">
                    <p class="to-animate">&copy; Insta Order <br> تم التصميم بواسطة <a href="https://www.allsafeeg.com/"
                            target="_blank">All Safe</a>
                    </p>
