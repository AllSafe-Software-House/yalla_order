...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"><a href="{{ route('categorycliniclist') }}">Category of Clinic</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Category of Clinic
                edit</span>
        </div>
    </div>
</div>
