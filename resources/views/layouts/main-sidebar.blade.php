        ...
        <ul class="side-menu">
            ...
            @can('showResturant')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('resturantlist') }}">List Resturant</a></li>
                    </ul>
                </li>
            @endcan
            @can('showClinic')
            ...
            <li class="side-item side-item-category">General Setting</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">Cash Back</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('cashback-settings.index') }}">Cash Back Setting</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('pagechangepassword') }}">Change Password</a></li>
